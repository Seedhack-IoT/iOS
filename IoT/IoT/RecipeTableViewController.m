...
@interface RecipeTableViewController ()<AddViewControllerDelegate>
{
...
{
    AddViewController *dvController = [segue destinationViewController];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@",myItems[indexPath.row]];
